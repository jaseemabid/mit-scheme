...
$Id: svm1-defns.h,v 1.1.2.1 2005/08/22 18:06:00 cph Exp $
...
#define SVM1_INST_CJUMP_LT_WR_PCR_S8 0x45
#define DECODE_SVM1_INST_CJUMP_LT_WR_PCR_S8(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_8 (value);

#define SVM1_INST_CJUMP_GE_WR_PCR_S8 0x46
#define DECODE_SVM1_INST_CJUMP_GE_WR_PCR_S8(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_8 (value);

#define SVM1_INST_CJUMP_GT_WR_PCR_S8 0x47
#define DECODE_SVM1_INST_CJUMP_GT_WR_PCR_S8(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_8 (value);

#define SVM1_INST_CJUMP_LE_WR_PCR_S8 0x48
#define DECODE_SVM1_INST_CJUMP_LE_WR_PCR_S8(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_8 (value);

#define SVM1_INST_CJUMP_SLT_WR_PCR_S8 0x49
#define DECODE_SVM1_INST_CJUMP_SLT_WR_PCR_S8(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_8 (value);

#define SVM1_INST_CJUMP_SGE_WR_PCR_S8 0x4a
#define DECODE_SVM1_INST_CJUMP_SGE_WR_PCR_S8(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_8 (value);

#define SVM1_INST_CJUMP_SGT_WR_PCR_S8 0x4b
#define DECODE_SVM1_INST_CJUMP_SGT_WR_PCR_S8(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_8 (value);

#define SVM1_INST_CJUMP_SLE_WR_PCR_S8 0x4c
#define DECODE_SVM1_INST_CJUMP_SLE_WR_PCR_S8(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_8 (value);

#define SVM1_INST_CJUMP_EQ_WR_PCR_S16 0x4d
#define DECODE_SVM1_INST_CJUMP_EQ_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_NEQ_WR_PCR_S16 0x4e
#define DECODE_SVM1_INST_CJUMP_NEQ_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_LT_WR_PCR_S16 0x4f
#define DECODE_SVM1_INST_CJUMP_LT_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_GE_WR_PCR_S16 0x50
#define DECODE_SVM1_INST_CJUMP_GE_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_GT_WR_PCR_S16 0x51
#define DECODE_SVM1_INST_CJUMP_GT_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_LE_WR_PCR_S16 0x52
#define DECODE_SVM1_INST_CJUMP_LE_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_SLT_WR_PCR_S16 0x53
#define DECODE_SVM1_INST_CJUMP_SLT_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_SGE_WR_PCR_S16 0x54
#define DECODE_SVM1_INST_CJUMP_SGE_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_SGT_WR_PCR_S16 0x55
#define DECODE_SVM1_INST_CJUMP_SGT_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_SLE_WR_PCR_S16 0x56
#define DECODE_SVM1_INST_CJUMP_SLE_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_EQ_WR_PCR_S32 0x57
#define DECODE_SVM1_INST_CJUMP_EQ_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_NEQ_WR_PCR_S32 0x58
#define DECODE_SVM1_INST_CJUMP_NEQ_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_LT_WR_PCR_S32 0x59
#define DECODE_SVM1_INST_CJUMP_LT_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_GE_WR_PCR_S32 0x5a
#define DECODE_SVM1_INST_CJUMP_GE_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_GT_WR_PCR_S32 0x5b
#define DECODE_SVM1_INST_CJUMP_GT_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_LE_WR_PCR_S32 0x5c
#define DECODE_SVM1_INST_CJUMP_LE_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_SLT_WR_PCR_S32 0x5d
#define DECODE_SVM1_INST_CJUMP_SLT_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_SGE_WR_PCR_S32 0x5e
#define DECODE_SVM1_INST_CJUMP_SGE_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_SGT_WR_PCR_S32 0x5f
#define DECODE_SVM1_INST_CJUMP_SGT_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_SLE_WR_PCR_S32 0x60
#define DECODE_SVM1_INST_CJUMP_SLE_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_FIX_WR_PCR_S8 0x61
#define DECODE_SVM1_INST_CJUMP_FIX_WR_PCR_S8(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_8 (value);

#define SVM1_INST_CJUMP_NFIX_WR_PCR_S8 0x62
#define DECODE_SVM1_INST_CJUMP_NFIX_WR_PCR_S8(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_8 (value);

#define SVM1_INST_CJUMP_IFIX_WR_PCR_S8 0x63
#define DECODE_SVM1_INST_CJUMP_IFIX_WR_PCR_S8(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_8 (value);

#define SVM1_INST_CJUMP_NIFIX_WR_PCR_S8 0x64
#define DECODE_SVM1_INST_CJUMP_NIFIX_WR_PCR_S8(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_8 (value);

#define SVM1_INST_CJUMP_FIX_WR_PCR_S16 0x65
#define DECODE_SVM1_INST_CJUMP_FIX_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_NFIX_WR_PCR_S16 0x66
#define DECODE_SVM1_INST_CJUMP_NFIX_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_IFIX_WR_PCR_S16 0x67
#define DECODE_SVM1_INST_CJUMP_IFIX_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_NIFIX_WR_PCR_S16 0x68
#define DECODE_SVM1_INST_CJUMP_NIFIX_WR_PCR_S16(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_16 (value);

#define SVM1_INST_CJUMP_FIX_WR_PCR_S32 0x69
#define DECODE_SVM1_INST_CJUMP_FIX_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_NFIX_WR_PCR_S32 0x6a
#define DECODE_SVM1_INST_CJUMP_NFIX_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_IFIX_WR_PCR_S32 0x6b
#define DECODE_SVM1_INST_CJUMP_IFIX_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_NIFIX_WR_PCR_S32 0x6c
#define DECODE_SVM1_INST_CJUMP_NIFIX_WR_PCR_S32(source, value) \
  DECODE_WORD_REGISTER (source); \
  DECODE_SIGNED_32 (value);

#define SVM1_INST_CJUMP_EQ_FR_FR_PCR_S8 0x6d
...
#define SVM1_INST_INTERRUPT_TEST_PROCEDURE 0xa1

#define SVM1_INST_INTERRUPT_TEST_DYNAMIC_LINK 0xa2

#define SVM1_INST_INTERRUPT_TEST_CLOSURE 0xa3

#define SVM1_INST_INTERRUPT_TEST_IC_PROCEDURE 0xa4

#define SVM1_INST_INTERRUPT_TEST_CONTINUATION 0xa5

#define SVM1_INST_FLONUM_HEADER_U8 0xa6
#define DECODE_SVM1_INST_FLONUM_HEADER_U8(target, value) \
  DECODE_WORD_REGISTER (target); \
  DECODE_UNSIGNED_8 (value);

#define SVM1_INST_FLONUM_HEADER_U16 0xa7
#define DECODE_SVM1_INST_FLONUM_HEADER_U16(target, value) \
  DECODE_WORD_REGISTER (target); \
  DECODE_UNSIGNED_16 (value);

#define SVM1_INST_FLONUM_HEADER_U32 0xa8
#define DECODE_SVM1_INST_FLONUM_HEADER_U32(target, value) \
  DECODE_WORD_REGISTER (target); \
  DECODE_UNSIGNED_32 (value);

#define SVM1_INST_FLONUM_HEADER 0xa9
#define DECODE_SVM1_INST_FLONUM_HEADER(target, n_elts) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (n_elts);

#define SVM1_INST_COPY_WR 0xaa
#define DECODE_SVM1_INST_COPY_WR(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_COPY_FR 0xab
#define DECODE_SVM1_INST_COPY_FR(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_NEGATE_WR 0xac
#define DECODE_SVM1_INST_NEGATE_WR(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_NEGATE_FR 0xad
#define DECODE_SVM1_INST_NEGATE_FR(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_INCREMENT_WR 0xae
#define DECODE_SVM1_INST_INCREMENT_WR(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_INCREMENT_FR 0xaf
#define DECODE_SVM1_INST_INCREMENT_FR(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_DECREMENT_WR 0xb0
#define DECODE_SVM1_INST_DECREMENT_WR(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_DECREMENT_FR 0xb1
#define DECODE_SVM1_INST_DECREMENT_FR(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_ABS_WR 0xb2
#define DECODE_SVM1_INST_ABS_WR(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_ABS_FR 0xb3
#define DECODE_SVM1_INST_ABS_FR(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_OBJECT_TYPE 0xb4
#define DECODE_SVM1_INST_OBJECT_TYPE(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_OBJECT_DATUM 0xb5
#define DECODE_SVM1_INST_OBJECT_DATUM(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_OBJECT_ADDRESS 0xb6
#define DECODE_SVM1_INST_OBJECT_ADDRESS(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_FIXNUM_TO_INTEGER 0xb7
#define DECODE_SVM1_INST_FIXNUM_TO_INTEGER(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_INTEGER_TO_FIXNUM 0xb8
#define DECODE_SVM1_INST_INTEGER_TO_FIXNUM(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_NOT 0xb9
#define DECODE_SVM1_INST_NOT(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_FLONUM_ALIGN 0xba
#define DECODE_SVM1_INST_FLONUM_ALIGN(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_FLONUM_LENGTH 0xbb
#define DECODE_SVM1_INST_FLONUM_LENGTH(target, source) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source);

#define SVM1_INST_SQRT 0xbc
#define DECODE_SVM1_INST_SQRT(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_ROUND 0xbd
#define DECODE_SVM1_INST_ROUND(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_CEILING 0xbe
#define DECODE_SVM1_INST_CEILING(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_FLOOR 0xbf
#define DECODE_SVM1_INST_FLOOR(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_TRUNCATE 0xc0
#define DECODE_SVM1_INST_TRUNCATE(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_LOG 0xc1
#define DECODE_SVM1_INST_LOG(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_EXP 0xc2
#define DECODE_SVM1_INST_EXP(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_COS 0xc3
#define DECODE_SVM1_INST_COS(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_SIN 0xc4
#define DECODE_SVM1_INST_SIN(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_TAN 0xc5
#define DECODE_SVM1_INST_TAN(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_ACOS 0xc6
#define DECODE_SVM1_INST_ACOS(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_ASIN 0xc7
#define DECODE_SVM1_INST_ASIN(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_ATAN 0xc8
#define DECODE_SVM1_INST_ATAN(target, source) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source);

#define SVM1_INST_ADD_WR 0xc9
#define DECODE_SVM1_INST_ADD_WR(target, source1, source2) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source1); \
  DECODE_WORD_REGISTER (source2);

#define SVM1_INST_ADD_FR 0xca
#define DECODE_SVM1_INST_ADD_FR(target, source1, source2) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source1); \
  DECODE_FLOAT_REGISTER (source2);

#define SVM1_INST_SUBTRACT_WR 0xcb
#define DECODE_SVM1_INST_SUBTRACT_WR(target, source1, source2) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source1); \
  DECODE_WORD_REGISTER (source2);

#define SVM1_INST_SUBTRACT_FR 0xcc
#define DECODE_SVM1_INST_SUBTRACT_FR(target, source1, source2) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source1); \
  DECODE_FLOAT_REGISTER (source2);

#define SVM1_INST_MULTIPLY_WR 0xcd
#define DECODE_SVM1_INST_MULTIPLY_WR(target, source1, source2) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source1); \
  DECODE_WORD_REGISTER (source2);

#define SVM1_INST_MULTIPLY_FR 0xce
#define DECODE_SVM1_INST_MULTIPLY_FR(target, source1, source2) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source1); \
  DECODE_FLOAT_REGISTER (source2);

#define SVM1_INST_QUOTIENT 0xcf
#define DECODE_SVM1_INST_QUOTIENT(target, source1, source2) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source1); \
  DECODE_WORD_REGISTER (source2);

#define SVM1_INST_REMAINDER 0xd0
#define DECODE_SVM1_INST_REMAINDER(target, source1, source2) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source1); \
  DECODE_WORD_REGISTER (source2);

#define SVM1_INST_LSH 0xd1
#define DECODE_SVM1_INST_LSH(target, source1, source2) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source1); \
  DECODE_WORD_REGISTER (source2);

#define SVM1_INST_AND 0xd2
#define DECODE_SVM1_INST_AND(target, source1, source2) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source1); \
  DECODE_WORD_REGISTER (source2);

#define SVM1_INST_ANDC 0xd3
#define DECODE_SVM1_INST_ANDC(target, source1, source2) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source1); \
  DECODE_WORD_REGISTER (source2);

#define SVM1_INST_OR 0xd4
#define DECODE_SVM1_INST_OR(target, source1, source2) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source1); \
  DECODE_WORD_REGISTER (source2);

#define SVM1_INST_XOR 0xd5
#define DECODE_SVM1_INST_XOR(target, source1, source2) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source1); \
  DECODE_WORD_REGISTER (source2);

#define SVM1_INST_MAX_UNSIGNED 0xd6
#define DECODE_SVM1_INST_MAX_UNSIGNED(target, source1, source2) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source1); \
  DECODE_WORD_REGISTER (source2);

#define SVM1_INST_MIN_UNSIGNED 0xd7
#define DECODE_SVM1_INST_MIN_UNSIGNED(target, source1, source2) \
  DECODE_WORD_REGISTER (target); \
  DECODE_WORD_REGISTER (source1); \
  DECODE_WORD_REGISTER (source2);

#define SVM1_INST_DIVIDE 0xd8
#define DECODE_SVM1_INST_DIVIDE(target, source1, source2) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source1); \
  DECODE_FLOAT_REGISTER (source2);

#define SVM1_INST_ATAN2 0xd9
#define DECODE_SVM1_INST_ATAN2(target, source1, source2) \
  DECODE_FLOAT_REGISTER (target); \
  DECODE_FLOAT_REGISTER (source1); \
  DECODE_FLOAT_REGISTER (source2);

#define SVM1_TRAP_0_ADD 0x00

#define SVM1_TRAP_0_DECREMENT 0x01

#define SVM1_TRAP_0_DIVIDE 0x02

#define SVM1_TRAP_0_EQUAL_P 0x03

#define SVM1_TRAP_0_GREATER_P 0x04

#define SVM1_TRAP_0_INCREMENT 0x05

#define SVM1_TRAP_0_LESS_P 0x06

#define SVM1_TRAP_0_MODULO 0x07

#define SVM1_TRAP_0_MULTIPLY 0x08

#define SVM1_TRAP_0_NEGATIVE_P 0x09

#define SVM1_TRAP_0_OPERATOR_1_0 0x0a

#define SVM1_TRAP_0_OPERATOR_2_0 0x0b

#define SVM1_TRAP_0_OPERATOR_2_1 0x0c

#define SVM1_TRAP_0_OPERATOR_3_0 0x0d

#define SVM1_TRAP_0_OPERATOR_3_1 0x0e

#define SVM1_TRAP_0_OPERATOR_3_2 0x0f

#define SVM1_TRAP_0_OPERATOR_4_0 0x10

#define SVM1_TRAP_0_OPERATOR_4_1 0x11

#define SVM1_TRAP_0_OPERATOR_4_2 0x12

#define SVM1_TRAP_0_OPERATOR_4_3 0x13

#define SVM1_TRAP_0_OPERATOR_APPLY 0x14

#define SVM1_TRAP_0_OPERATOR_LEXPR 0x15

#define SVM1_TRAP_0_OPERATOR_LOOKUP 0x16

#define SVM1_TRAP_0_OPERATOR_PRIMITIVE 0x17

#define SVM1_TRAP_0_POSITIVE_P 0x18

#define SVM1_TRAP_0_QUOTIENT 0x19

#define SVM1_TRAP_0_REFLECT_TO_INTERFACE 0x1a

#define SVM1_TRAP_0_REMAINDER 0x1b

#define SVM1_TRAP_0_RETURN_TO_INTERPRETER 0x1c

#define SVM1_TRAP_0_SUBTRACT 0x1d

#define SVM1_TRAP_0_ZERO_P 0x1e

#define SVM1_TRAP_1_ERROR 0x00

#define SVM1_TRAP_1_LOOKUP 0x01

#define SVM1_TRAP_1_PRIMITIVE_APPLY 0x02

#define SVM1_TRAP_1_PRIMITIVE_LEXPR_APPLY 0x03

#define SVM1_TRAP_1_SAFE_LOOKUP 0x04

#define SVM1_TRAP_1_UNASSIGNED_P 0x05

#define SVM1_TRAP_2_APPLY 0x00

#define SVM1_TRAP_2_ASSIGNMENT 0x01

#define SVM1_TRAP_2_LEXPR_APPLY 0x02

#define SVM1_TRAP_2_PRIMITIVE_ERROR 0x03

#define SVM1_TRAP_3_CACHE_REFERENCE_APPLY 0x00

#define SVM1_TRAP_3_LINK 0x01
