...
$Id: cmpint.c,v 1.103.2.1 2005/08/22 18:05:57 cph Exp $
...
#elif (COMPILER_PROCESSOR_TYPE == COMPILER_IA32_TYPE)
...
static SCHEME_OBJECT read_uuo_target_no_reloc (SCHEME_OBJECT *);
...
#else /* not (COMPILER_PROCESSOR_TYPE == COMPILER_SVM_TYPE) */
...
#endif /* not (COMPILER_PROCESSOR_TYPE == COMPILER_SVM_TYPE) */
...
#define REGBLOCK_LENGTH							\
  ...
  static SCHEME_OBJECT register_array [REGBLOCK_LENGTH];
  SCHEME_OBJECT * Registers = register_array;
#endif
