...
$Header: /Users/cph/tmp/foo/mit-scheme/mit-scheme/v7/src/compiler/machines/bobcat/machin.scm,v 4.13.1.2 1989/05/11 17:40:26 arthur Exp $
  ...
  (let ((references (make-vector number-of-machine-registers)))
    (let loop ((i 0) (j 8))
	  ...
	  (begin (vector-set! references i (INST-EA (D ,i)))
		 ...
		 (loop (1+ i) (1+ j)))))    (let loop ((i 16) (names '(FP0 FP1 FP2 FP3 FP4 FP5 FP6 FP7)))
      (if (not (null? names))
