...
;;; names have "string" replaced by "ustring".  This is a transitional
;;; implementation to convert MIT/GNU Scheme to full Unicode string support.
;;;
;;; At some point in the future we'll rename everything back to "string".

;; (ustring-ci<=? string1 string2 . strings)
;; (ustring-ci<? string1 string2 . strings)
;; (ustring-ci>=? string1 string2 . strings)
;; (ustring-ci>? string1 string2 . strings)
;; (ustring-foldcase string)
;; (read-uline #!optional port)
;; (vector->ustring vector #!optional start end)
